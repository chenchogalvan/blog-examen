                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}"  class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}"  aria-describedby="tituloHelp" placeholder="Ej: ¡Como hacer la mejor pizza en asador!">
                            @if ($errors->has('title'))
